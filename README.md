...
- **ハイブリッドアーキテクチャ**: コアロジックは C++17 で記述され、柔軟なスクリプティングのために Lua 5.4.9 を組み込んでいます。
- **高性能レイトレーシング**: Intel Embree 4.4.1 を使用した高速なレイトレーシング。
...
- **言語**: C++17, Lua 5.4.9, JavaScript/TypeScript
- **ライブラリ**:
